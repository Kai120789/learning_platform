...
import { DropdownMenuIcons } from "@/features/dropdownMenu/ui/DropdownMenuIcons";
...
const RightTopMenu = ({ onClick }: RightTopMenuProps) => {
    return (
        <div className="border-b-2 border-[#D9D9D9]">
            <div className="flex flex-row p-[20px] justify-between">
                ...
                <div className="flex flex-row  gap-4">
                    ...
                    <DropdownMenuIcons trigger={<FaRegUserCircle className="size-6 cursor-pointer border-none" />} />
                </div>
